...
def respawn(inicio_estrada=estrada.inicio_estrada, final_estrada=estrada.final_estrada):
    x_carro_inimigo = [random.randint(inicio_estrada, final_estrada),
                       random.randint(inicio_estrada, final_estrada),
                       random.randint(inicio_estrada, final_estrada),
                       random.randint(inicio_estrada, final_estrada)]
